<x-app-layout>
    ...
    <div class="bg-gray-50">
        <div class="relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <div class="max-w-7xl mx-auto px-4 py-4 sm:py-6 sm:px-6">
                    <div id="owl-1" class="owl-carousel">
                        <div id="owl-1-item-1" class="item row" style='background-image: url("/storage/slider/slider1.jpg")'>
                            <div class="xLarge-6 large-6 medium-12 small-12 xSmall-12">
                                <div class="my-6 mx-6 py-6 px-6 bg-white bg-opacity-50 rounded-md shadow">
                                    <h2 class="text-4xl tracking-tight font-extrabold text-indigo-900 sm:text-5xl md:text-6xl">
                                        <span class="block">Mon titre</span>
                                    </h2>
                        ...
                        <div id="owl-1-item-2" class="item row" style='background-image: url("/storage/slider/slider2.jpg")'>
                            <div class="xLarge-6 large-6 medium-12 small-12 xSmall-12">
                                <div class="my-6 mx-6 py-6 px-6 bg-white bg-opacity-50 rounded-md shadow">
                                    <h2 class="text-4xl tracking-tight font-extrabold text-indigo-900 sm:text-5xl md:text-6xl">
                                        <span class="block">Mon titre</span>
                        ...
                        <div id="owl-1-item-3" class="item row" style='background-image: url("/storage/slider/slider3.jpg")'>
                            <div class="xLarge-6 large-6 medium-12 small-12 xSmall-12">
                                <div class="my-6 mx-6 py-6 px-6 bg-white bg-opacity-50 rounded-md shadow">
                                    <h2 class="text-4xl tracking-tight font-extrabold text-indigo-900 sm:text-5xl md:text-6xl">
                                        <span class="block">Mon titre</span>
    ...
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div class="bg-gray-50">
        <div class="max-w-7xl mx-auto pt-16 px-4 sm:px-6 lg:pt-24 lg:px-8">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl font-extrabold text-gray-900">Our Team</h2>
                <p class="mt-4 text-lg text-gray-500">Ac euismod vel sit maecenas id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla nec.</p>
            </div>
        </div>
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
